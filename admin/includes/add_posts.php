...
if (isset($_POST['create_post'])) {
    ...
    try {
        ...
        move_uploaded_file($post_image_temp, "../images/$post_image");
            ...
            $stmt = $conn->prepare("INSERT INTO posts(post_title,post_category_id,post_author,post_status,post_image,post_date,post_tags,post_content,post_comment_count) 
            VALUES ('{$post_title}','{$post_category_id}','{$post_author}','{$post_status}','{$post_image}',Now(),'{$post_tags}','{$post_content}','{$post_comment_count}') ");
            $stmt->execute(); 
