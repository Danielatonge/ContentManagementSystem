...
if (isset($_GET['update'])) {
    ...
    try {
                    ...
                    //update user edited information to the users table
                    if(isset($_POST['update_user'])) {
                        ...
                        move_uploaded_file($user_image_temp, "../images/$user_image");
                            ...
                            echo 'The following fields should not be empty Username, Email';
                                ...
                                echo "<div class='alert alert-success'> User successfully Updated. View user " . "<a href='users.php'>Here</a></div>"; 
                            ...
                            echo 'Error:' .$e->getMessage();
                                ...
                                //Select the user information to be edited
                                $stmt = $conn->prepare("SELECT * FROM users WHERE user_id={$user_id}"); 
                                $stmt->execute();
  ...
  <form action="" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
       ...
       <input type="password" class="form-control" name="password" placeholder="Enter new password to modify or leave field empty to maintain old password">
    </div>
